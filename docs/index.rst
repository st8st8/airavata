...
.. |status27| image:: http://jenkins.lasolution.be/buildStatus/icon?job=Polla/PYTHON=System-CPython-2.7&build=57
.. |status32| image:: http://jenkins.lasolution.be/buildStatus/icon?job=Polla/PYTHON=System-CPython-3.2&build=57
.. |status34| image:: http://jenkins.lasolution.be/buildStatus/icon?job=Polla/PYTHON=CPython-3.4&build=57
